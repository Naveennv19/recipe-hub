...
import { Trash2, Flame, Drumstick, Clock, UtensilsCrossed } from 'lucide-react';
  ...
  export const RecipeCard = ({ r, onDelete, onClick }: RecipeCardProps) => {
    ...
    return (
      ...
      >
        ...
        {/* Meal Type and Taste Profile */}
        <div className="mb-3">
          <div className="flex items-center text-sm text-gray-600 mb-1">
            <Clock size={14} className="mr-1 text-blue-500" />
            <span className="font-medium">Meal:</span>
            <span className="ml-1">{parseArrayData(r.mealType)}</span>
          </div>
          <div className="flex items-center text-sm text-gray-600">
            <UtensilsCrossed size={14} className="mr-1 text-purple-500" />
            <span className="font-medium">Taste:</span>
            <span className="ml-1">{parseArrayData(r.tasteProfile)}</span>
          </div>
        </div>
